...
Para editar el código en VS, se debe agregar la carpeta dónde están los archivos de la página web al espacio de trabajo. En el menú "File", elegir la opción "Add Folder to Workspace".
