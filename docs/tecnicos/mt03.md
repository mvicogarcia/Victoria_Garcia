...
![](../images/dispar.jpg) ![](../images/dispar2.jpg)
...
- Utilicé Inkscape para agrear el logo y obtener un archivo vectorial. En *propiedades del documento*, puse mm en *unidad de visualización* y en *unidades* de la página. También cabié el tamaño de la página a 900x600mm, que corresponde al área de trabajo de la máquina láser a usar.
...
Nos recibieron Facundo, Martina y Joaquín, docentes de UTEC, que nos enseñaron el funcionamiento de cortadora de láser y del laboratorio en general, así como pruebas y proyectos en los que trabajan.
...
Finalmente, este es el prototipo con mejor resultado. Todavía quedan varios ajustes por realizar, e incluso pruebas de diferentes encastres que me sugirieron mis compañeros.
