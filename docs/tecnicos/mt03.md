...
- Luego importé el dxf a Fusion, y lo usé como boceto para el modelado 3D. Parametricé los valores de espesor de la pieza, y los encastres.

![](../images/fusion.jpg)

- Utilicé Inkscape para agrear el logo y obtener un archivo vectorial.

![](../images/inkscape.jpg)

- Siguiendo el tutorial de Joaquín en la plataforma EDU, utilicé RDWorks para generar el archivo g-code.
