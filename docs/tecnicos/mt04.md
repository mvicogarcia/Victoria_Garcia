...
Nota: Para poder probarlo en el escritorio, modifiqué la distancia a la que se atyivan el buzzer y el led a 10cm.
...
**[Tutorial de Referencia](https://www.luisllamas.es/controlar-un-servo-con-arduino/)** 
