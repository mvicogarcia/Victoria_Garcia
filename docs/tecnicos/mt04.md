...
**Arduino:** es una plataforma para **[informática física](https://es.wikipedia.org/wiki/Inform%C3%A1tica_f%C3%ADsica)** de código abierto basada en hardware (placa electrónica) y software (**[Arduino IDE](https://www.arduino.cc/en/software)**), fácil de usar.
