...
5. Editamos el pin de salida donde tenemos conectado el LED (línea 37), en mi caso es el pin 32
6. Editamos la ubicación del LED en el texto ilustrativo (líneas 85 y 86) y en el digitalWrite (líneas 101 y 104)
7. Damos click en verificar para compilar el proyecto y luego en cargar para cargarlo en la placa
...
10. Copiar la dirección IP que nos muestra el Monitor Serie, en mi caso: 192.168.1.8
